  ...
  return (
    <div>
      ...
      <section>
        <h2>Introduction</h2>
        <p>
          With decades of experience, El Safwa Cargo and Export delivers
          reliable, efficient, and innovative cargo solutions tailored to meet
          your business needs worldwide. We specialize in seamless logistics,
